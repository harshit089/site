...
# Anchor all paths to the repo root (parent of this scripts/ folder) so the
# pipeline writes to the same docs/data/digests.json regardless of whether
# it's run from the repo root or from inside scripts/ (as GitHub Actions does
# via `working-directory: scripts`).
